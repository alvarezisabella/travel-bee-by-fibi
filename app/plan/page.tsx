        ...
        {itinerary!.days.map((day, dayIndex) => (
          <section key={day.date}>
            ...
            >
              ...
              <div>
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Day {dayIndex + 1}</p>
                <p className="text-base font-medium text-gray-700">{formatDate(day.date)}</p>
              </div>
            </div>
